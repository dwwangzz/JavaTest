 ...
 *
 */
public class ImageUtils_4 {
	
	
	public static void main(String[] args) throws IOException, InterruptedException {
		Image backImage = ImageUtils_4.loadImageLocal("E:/shuying.png");
		Image headImage = ImageUtils_4.loadImageLocal("E:/abc.jpg");
		ImageUtils_4.composePic(backImage, headImage, "E:/output.png", 500, 500);
		/*ImageUtils_4.composePic("E:/shuying.png", "http://t3.qlogo.cn/mbloghead/d387538f629cfb53c2b0/100", "E:/output.png", 53, 161);*/
	}
	...
	public static void composePic(String backPicPath, String headPicUrl, 
		...
		try {
			// 读取背景图片
			Image backImage = ImageUtils_4.loadImageLocal(backPicPath);
			
			// 加昵称
			int ln = ImageUtils_4.getLength("深水鱼的马甲") * 24;
			backImage = ImageUtils_4.pressText("深水鱼的马甲", backImage, "微软雅黑", Font.BOLD,
					ImageUtils_4.String2Color("#FFFFFF"), 24, 175+(266-ln)/2, 188, 1);
			// 得分
			backImage = ImageUtils_4.pressText("100分", backImage, "华康海报体W12(P)",  Font.LAYOUT_NO_LIMIT_CONTEXT,
					ImageUtils_4.String2Color("#FD6E10"), 22, 280, 233, 1);
			// 收益
			backImage = ImageUtils_4.pressText("85%", backImage, "迷你简凌波",  Font.LAYOUT_NO_LIMIT_CONTEXT,
					ImageUtils_4.String2Color("#E60000"), 24, 368, 264, 1);
			// 称号
			int lc = ImageUtils_4.getLength("有股神潜力，万众膜拜！") * 32;
			backImage = ImageUtils_4.pressText("有股神潜力，万众膜拜！", backImage, "华康海报体W12(P)", Font.LAYOUT_NO_LIMIT_CONTEXT,
					ImageUtils_4.String2Color("#880000"), 32, (488-lc)/2, 310, 1);
			// 读取头像图片
			Image headImage = ImageUtils_4.loadImageUrl(headPicUrl);
			// 图像
			ImageUtils_4.composePic(backImage, headImage, outPutPath, leftX, leftY);
