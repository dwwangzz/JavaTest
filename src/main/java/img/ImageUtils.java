 ...
 * 
 * @author wangzz-a
 * @version $Id: ImageUtils.java, v 0.1 2015年1月19日 下午3:39:39 wangzz-a Exp $
 */
public class ImageUtils {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i=1;i<11;i++){
			pressImage("D:/test/d"+i+".JPG", "D://test//shuying.png", -1, -1, 0.7f);
		}
		System.out.println("elapse time:" + (System.currentTimeMillis() - c) / 1000.0f + "s");
		 //pressText("D://test//1.jpg", "旺仔之印", "宋体", Font.BOLD|Font.ITALIC, 20, Color.BLACK, 0, 0, 8f);
